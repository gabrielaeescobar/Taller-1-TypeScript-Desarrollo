...
export var data = drivers.map(function (driver) { return new Driver(driver.nombre, driver.descripcion, driver.imagenPrincipal, driver.pilotoRivalidad, driver.descripcionRivalidad, driver.fotoRivalidad, driver.granPrixGanados1, driver.granPrixGanados2, driver.fotoGranPrix, driver.legadoTitulo1, driver.legadoDescripcion1, driver.legadoTitulo2, driver.legadoDescripcion2, driver.fotoLegado); });
